...
# ==============================================================================
    ...
    with info_col:
        ...
        <div class='glass-card'>
            ...
            <p>🐙 <b>GitHub Matrix:</b> <a href='https://github.com/bhardwajyuvika2305' target='_blank' style='color:#6366f1; text-decoration:none;'>Connect via Github</a></p>
            <p>🔗 <b>LinkedIn Portal:</b> <a href='https://www.linkedin.com/in/yuvika-bhardwaj2305/' target='_blank' style='color:#6366f1; text-decoration:none;'>Connect via LinkedIn</a></p>
            <p>📧 <b>Secure Email Link:</b> <a href='mailto:bhardwajyuvika2305@gmail.com' style='color:#6366f1; text-decoration:none;'>E-mail Address</a></p>
        </div>
        """, unsafe_allow_html=True)
